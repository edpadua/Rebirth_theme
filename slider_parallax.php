...
<div id="myCarousel" class="carousel slide carousel-fade" data-ride="carousel" data-speed="3000" data-interval="<?php echo get_theme_mod( 'slide_interval','6000' ); ?>">
                          ...
                          <div id="carousel-item" class="carousel-inner" role="listbox">
                            <div class="item active">
                                ...
                                <div class="parallax-slide parallax-sec" style='background-image: url("<?php echo esc_url( get_theme_mod( 'imagem_slide1' ) ); ?>");' ></div>
                            ...
                            <div class="item">
                              <div class="parallax-slide parallax-sec" style='background-image: url("<?php echo esc_url( get_theme_mod( 'imagem_slide2' ) ); ?>");' ></div>
                            ...
                            <div class="item">
                                 <div class="parallax-slide parallax-sec" style='background-image: url("<?php echo esc_url( get_theme_mod( 'imagem_slide3' ) ); ?>");' ></div>
                            ...
                            <div class="item">
                                 <div class="parallax-slide parallax-sec" style='background-image: url("<?php echo esc_url( get_theme_mod( 'imagem_slide4' ) ); ?>");' ></div>
