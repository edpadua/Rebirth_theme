...
<header id="header_vertical" class="main_header_vertical">
                 
                         <div id="top-line"></div>
                         <div class="main-nav-container-center">
                                   <div class="container" >
                                   
                                      <div class="logo_container_vertical">
                                       ...
                                       <div class="nav-container-vertical">
                                            <nav class="top-menu-nav font_header">
                                                <?php 
                                                    wp_nav_menu( array(
                                                        'theme_location' => 'primary',
                                                        'container' => false,
                                                        'menu_class' => 'naveg-vertical navbar-nav-vertical',
                          ...
                          <div class="nav-container-mobile-vertical">
